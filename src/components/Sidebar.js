...
const Sidebar = () => {
  ...
  return (
    <div className={`${isOpen ? 'right-0' : '-right-full'}
          w-full bg-white fixed top-0 h-full shadow-2x1 md:w-[35vw] xl:max-w-[30vw]
        ...
        <div className='flex flex-col gap-y-2 h-[520px] lg:h-[350px]
        ...
        <div className='flex flex-col gap-y-3 py-4 mt-4'>
          <div className='flex w-full justify-between items-center'>
            ...
            <div onClick={clearCart} className='cursor-pointer w-12 h-12 text-x1 py-4 bg-red-500 text-wight
